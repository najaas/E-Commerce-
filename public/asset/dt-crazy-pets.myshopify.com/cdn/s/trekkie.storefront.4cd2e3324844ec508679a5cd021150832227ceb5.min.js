!(function () {
  var e = {
        ...
        t.updateTrackingConsent = function (e, t) {
          ...
          n.open("POST", "/set_tracking_consent.json", !0),
            ...
            (n.onreadystatechange = function () {
              ...
              var a;
              0 === (a = n.status) || (200 >= a && a < 400)
                ? (r.dispatchEvents(e), t(null, i))
                : t(i);
            }),
            n.send(i);
        };
      ...
      5841: function (e, t, n) {
        ...
        (t.CONSENT_COOKIE_NAME = a),
          ...
          (t.getRegulationValue = function () {
            const e = c();
            return p(e) ? o.TrackingRegulations.NO_VALUE : e.reg;
          }),
          (t.getSignal = d),
        ...
        (t.saleOfDataRegion = a.saleOfDataRegion),
          ...
          (t.shouldShowCCPABanner = function () {
            return (
              ...
              a.saleOfDataRegion() &&
                _() === r.DisplayConsentValues.NO_INTERACTION
            );
          }),
      ...
      1449: function (e, t) {
        ...
        (t.readCookie = function (e, t = null) {
              ...
              (function (e) {
                ...
                for (let o = 0; o < t.length; o++) {
                  ...
                  if (e === decodeURIComponent(r))
                    return (n[e] = JSON.parse(decodeURIComponent(i))), n[e];
                }
              })(e) ||
              (function (e, t) {
                if (null === t) return;
                ...
                if (i instanceof HTMLMetaElement) {
                  ...
                  try {
                    ...
                    if (((r = Object.fromEntries(e)), r.purposes)) {
                      const e = r.purposes
                          .split(/(true|false)/)
                          .filter(Boolean),
                        t = {};
          ...
          (t.writeCookie = function (e, t, r, i) {
            if (!o(i))
          ...
          fetch(`https://${n.checkoutRootDomain}/api/unstable/graphql.json`, c)
            ...
            .then((s) => {
              const c = 31536e6,
                ...
                p = "." + (n.storefrontRootDomain || window.location.hostname),
                d = s.data.consentManagement.cookies.trackingConsentCookie,
                l = s.data.consentManagement.cookies.answersCookie;
              r.writeCookie(i.CONSENT_COOKIE_NAME, u, c, d),
                r.writeCookie(a.CMP_ANSWERS_COOKIE_NAME, u, c, l),
                p !== u &&
                  (r.writeCookie(i.CONSENT_COOKIE_NAME, p, c, d),
                  r.writeCookie(a.CMP_ANSWERS_COOKIE_NAME, p, c, l)),
                o.dispatchEvents(e),
                t(null, s);
            })
            .catch((e) => {
        ...
        var a = n(7385),
          ...
          l = (function (e) {
            function t(n, o) {
              ...
              return (r.campaignManager = new d.CampaignManager()), r;
            }
            return (
              r(t, e),
      ...
      3653: function (e, t, n) {
        ...
        var h = (function (e) {
          function n(t, o) {
            ...
            return (r.pageID = v.default.microSessionId), r;
          }
          return (
            r(n, e),
            ...
            (n.prototype.eventWithMetadata = function (e, t, n) {
              ...
              return i(i({}, t), {
                ...
                asset_version_id: "4cd2e3324844ec508679a5cd021150832227ceb5",
        ...
        function h(e) {
          if (void 0 === o)
            if (
              ...
              for (
                var t = "", n = 0, r = p.hostname().split(".").reverse();
                n < r.length;
                n++
              ) {
                var i = r[n];
      ...
      7662: function (e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.saleOfDataAllowed =
            ...
            t.TrackingEvents =
              void 0);
        var o = n(1863);
        Object.defineProperty(t, "analyticsProcessingAllowed", {
          enumerable: !0,
          get: function () {
            return o.analyticsProcessingAllowed;
          },
        }),
          Object.defineProperty(t, "marketingAllowed", {
            enumerable: !0,
            get: function () {
              return o.marketingAllowed;
            },
          }),
          Object.defineProperty(t, "preferencesProcessingAllowed", {
            enumerable: !0,
            get: function () {
              return o.preferencesProcessingAllowed;
            },
          }),
          Object.defineProperty(t, "saleOfDataAllowed", {
            enumerable: !0,
            get: function () {
              return o.saleOfDataAllowed;
            },
          });
        var r = n(542);
        function i() {
        ...
        function a(e) {
          return e
            ? Boolean(
                e.analyticsAllowed || e.marketingAllowed || e.saleOfDataAllowed
              )
        ...
        function s(e, t) {
          switch (e) {
            ...
            case r.ConsentPurposes.FIRST_PARTY_MARKETING:
              return t.marketingAllowed;
            case r.ConsentPurposes.THIRD_PARTY_MARKETING:
              return t.saleOfDataAllowed;
        ...
        (t.TrackingEvents = o.TrackingEvents),
          ...
          (t.isGDPREnforced = function () {
            return !(o.marketingAllowed() && o.analyticsProcessingAllowed());
          }),
          (t.userDataCannotBeSold = i),
          ...
          (t.haveConsentForMarketingOrAnalytics = a),
        ...
        (t.metricsSchemaId = "trekkie_metrics/2.0"),
          ...
          (t.sendToBugsnag = function (e) {
            ...
            if (this.shouldSendToBugsnag()) {
              var n = "4cd2e3324844ec508679a5cd021150832227ceb5",
                o = null,
                r = null,
                i = null;
              if (e.appConfig)
          ...
          C = (function () {
            function e(e, t, n) {
              ...
              (this.integrations = []),
                ...
                g.default.initialize(t.Trekkie),
            ...
            return (
              ...
              (e.prototype.logAssetContext = function (e) {
                ...
                s.addBatchEvent({
                  ...
                  payload: {
                    build_id: "4cd2e3324844ec508679a5cd021150832227ceb5",
              ...
              (e.prototype.getNavigationType = function () {
                try {
                  var e = "PerformanceNavigationTiming",
                    t = v.getNavigationTypeExperimental();
                  return (
                    t ||
                      ((t = v.getNavigationTypeLegacy()),
                ...
                for (var i = 0, a = e; i < a.length; i++) {
                  ...
                  try {
                    ...
                    if (d && "object" == typeof d) {
                      var l = new (0, s[1])(d, r);
                      this.integrations.push(l);
                      var v = l.type() === f.IntegrationTypes.ECOMMERCE;
                      p.haveConsentForIntegration(l)
                        ? v
                          ? l.initialize(r)
                          : r()
                        : ((m[u] = [v, l, []]), r());
              ...
              (e.prototype.handleConsentCollectedEvent = function (e) {
                ...
                var t = e.detail;
                g.default.refreshVisitorTokens();
      ...
      803: function (e, t, n) {
        ...
        const o = "sh",
          ...
          v = "checkout_contact_step_started",
          _ = "checkout_contact_info_submitted",
          h = "checkout_address_info_submitted",
  ...
  (n.d = function (e, t) {
    ...
    (function () {
      ...
      i.push(["S2S", f.S2S]);
      try {
        var v = window[r].config;
        if (v) {
          t.setGlobalSerializedAppConfig(JSON.stringify(v));
          var _ = window[r],
            h = (window.trekkie = new e.Tricorder(i, v, function () {
              (window[r] = h),
                (window._visit = {
                  tag: function () {},
