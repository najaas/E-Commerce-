(() => {
      ...
      332: function (e, t, r) {
        ...
        !(function (n, o) {
          ...
          var a = "function",
            ...
            J = function (e, t) {
              if ((typeof e === c && ((t = e), (e = o)), !(this instanceof J)))
              ...
              return (
                ...
                (this.setUA = function (e) {
                  return (
                    (i = typeof e === l && e.length > 350 ? H(e, 350) : e), this
                  );
                }),
                this.setUA(i),
                this
  ...
  (r.amdO = {}),
    ...
    (() => {
          ...
          if ("object" == typeof n) {
            ...
            if (u in n) {
              ...
              Object.defineProperties(p, {
                [t]: { value: d, writable: !1 },
                [e]: { value: b, writable: !1 },
                [i]: { value: f, writable: !1 },
              });
      ...
      const p = "production",
        m = "0.0.444",
        w = "3698dd31wbfa453bap448c3218md5149de6",
        g = "s3698dd31wbfa453bap448c3218md5149de6m.js";
      var h = r(856),
        v = r.n(h);
        ...
        O = (e, t) => {
          try {
                ...
                const r = v()
                  ...
                  .reduce((e, t) => {
                    const r = (function ({
                      ...
                      const i = /^global code$/i.test((n = e) || "")
                        ? "global code"
                        : n;
                      var n;
                      return {
            ...
            const c = (function (
                ...
                })(r || (null == (h = self.navigator) ? void 0 : h.userAgent));
                return {
                  payloadVersion: 5,
                  notifier: { name: "web-pixel-manager", version: m, url: "-" },
                  events: [
                    {
                      exceptions: [t],
                      context: i,
            ...
            if (!l)
              return void (
                null == (i = console) || i.log(`[${p}]`, "Bugsnag notify:", c)
              );
            fetch(l, {
              method: "POST",
              headers: {
      ...
      function N(e, t) {
        ...
        return {
          ...
          key(e) {
            var t;
            return null != (t = Array.from(r.keys()).find((t, r) => r === e))
              ? t
              : null;
          },
        };
        ...
        (function ({ webPixelApi: e, cookie: t, cookieRestrictedDomains: r }) {
          ...
          E(document, "cookie", {
            ...
            set: function (t) {
              ...
              if (
                !(r.filter((e) => new RegExp(`^\\.?${e}$`).test(o)).length > 0)
              ) {
                const r = i.getValue();
                i.update(
          ...
          (function ({ origin: e, internalApi: t }) {
            const r = A(e);
            E(window, "origin", {
              get: function () {
          ...
          (function ({ referrer: e, internalApi: t }) {
            const r = A(e);
            E(document, "referrer", {
          ...
          (function ({ webPixelApi: e, localStorageItems: t }) {
            const r = N(t, e.browser.localStorage);
          ...
          (function ({ webPixelApi: e, sessionStorageItems: t }) {
            const r = N(t, e.browser.sessionStorage);
      ...
      const C = new URL(self.location.href);
      ...
      function M(e) {
        const t = new URL(e);
        if ("https:" !== t.protocol)
          throw new L(`URL must be secure (HTTPS): ${t.href}`);
        const r = C.host.replace(/[/\-\\^$*+?.()|[\]{}]/g, "\\$&");
        if (new RegExp(`^https://(.*@)?${r}`, "i").test(t.href))
          throw new I(`Request are not allowed to the same origin: ${t.href}`);
        return t;
      }
      function B() {
        const e = XMLHttpRequest.prototype.open;
        return (
          (XMLHttpRequest.prototype.open = function (t, r, i = !0, n, o) {
            return e.call(this, t, M(r), i, n, o);
          }),
          XMLHttpRequest
        );
      }
      ...
      function D(e, t = self) {
        ...
        e ||
          ...
          E(self, "String", { writable: !1, configurable: !1 }),
          E(self, "Request", { writable: !1, configurable: !1 }),
          E(self, "URL", { writable: !1, configurable: !1 }),
          E(self, "RegExp", { writable: !1, configurable: !1 });
      }
      ...
      const $ = async (e) => {
        ...
        (V = !0), a(o), a(s);
        try {
          W && (o.browser.sendBeacon = R),
            W || (T(e), (self.document.title = r));
        } catch (l) {
          throw (
            (O(l, {
              pixelId: i.id,
        ...
        return (
          await (null == (t = _) ? void 0 : t.call(o, o)),
          { status: "success", hashVersion: w, sandboxUrl: C.href || "unknown" }
        );
      };
      !(function () {
        const e = W ? "worker" : "iframe";
        try {
          (function (
            e,
            { uuid: t = b, createEncoder: r = d, callable: i } = {}
          ) {
            let o = !1,
              a = e;
            const s = new Map(),
                ...
                switch (t[0]) {
                  ...
                  case 0: {
                    ...
                    try {
                      ...
                      throw (f(1, [i, { name: e, message: t, stack: n }]), r);
                    } finally {
                      e.release();
                    }
                    break;
                  ...
                  case 5: {
                    ...
                    try {
                      ...
                      throw (f(6, [e, { name: t, message: i, stack: n }]), r);
                    }
                    break;
                  }
                }
            ...
            function g() {
              ...
              (o = !0),
                ...
                a.removeEventListener("message", p);
            }
          })(
            W
              ? self
              : (function ({ targetOrigin: e = "*" } = {}) {
                  ...
                  return {
                    ...
                    removeEventListener(e, t) {
                      const r = i.get(t);
                      null != r &&
                        (i.delete(t), self.removeEventListener(e, r));
                    },
                  };
                })(),
            { callable: [] }
          ...
          O(t, { context: `v0/createSandbox/${e}` });
        }
        D(W);
      })();
    })();
